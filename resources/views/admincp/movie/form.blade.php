...
@endif
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('slug', isset($movie) ? $movie->slug : old('slug'), [
        ...
        'required' => 'required'
                            ...
                            <small class="form-text text-muted">
                                Slug phải là duy nhất, không được trùng với phim khác
                            </small>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('phude', ['0' => 'Phụ đề', '1' => 'Thuyết minh', '3' => 'Trailer'], isset($movie) ? $movie->phude : '', ['class' => 'form-control']) !!}
                        </div>
                        <div class="form-group">
