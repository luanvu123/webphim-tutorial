            ...
            <table class="table" id="tablephim">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row">{{$key}}</th>
                  <td>{{$cate->title}}</td>
                  <td><a href="{{route('add-episode',[$cate->id])}}" class="btn btn-danger btn-sm">Thêm tập</a></td>
                  <td>
                  ...
                  <td>
                   <!--  @if($cate->resolution==0)
                    ...
                    @endif -->
                    @php
                    $options = array('0'=>'HD','1'=>'SD','2'=>'HDCam','3'=>'Cam','4'=>'FullHD');
                  ...
                  <td>
                    ...
                    @elseif($cate->phude=1)
                        ...
                        <option value="1">Thuyết minh</option>
                        <option value="0">Phụ đề</option>
                        <option selected value="3">Trailer</option>
                    @endif
                         </select>
                  </td>
                  <td>
                  ...
                  <td>
                    ...
                    <select id="{{$cate->id}}"class="thuocphim_choose">
                        ...
                        <option value="phim">Phim lẻ</option>
                  ...
                  <td>
                    {!! Form::select('topview', ['0'=>'Ngày','1'=>'Tuần','2'=>'Tháng'], isset($cate->topview) ? $cate->topview : '', ['class'=>'select-topview','id'=>$cate->id,'placeholder'=>'--Top--']) !!}
                   
                  </td>
                  <td>
                    <form method="POST">
                      @csrf
                    {!! Form::selectYear('year',2000,2022, isset($cate->year) ? $cate->year : '',['class'=>'select-year','id'=>$cate->id,'placeholder'=>'--Năm--']) !!}
                  </form>
                  </td>
                  <td>
                    <form method="POST">
