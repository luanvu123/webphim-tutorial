...
<div class="row container" id="wrapper">
                        ...
                        <div class="movie_info col-xs-12">
                           ...
                           <div class="film-poster col-md-9">
                              ...
                              <ul class="list-info-group">
                                ...
                                <!--     <ion-icon name="chevron-forward-outline"></ion-icon><ion-icon name="desktop-sharp"></ion-icon> -->
                   <lord-icon
    ...
    style="width:20px;height:20px">
                                 ...
                                 Trạng Thái</span> : <span class="quality">
    ...
    style="width:20px;height:20px">
                                    ...
                                    Thời lượng</span> : {{$movie->thoiluong}}</li>
                                 <li class="list-info-group-item">
<lord-icon
    ...
    style="width:20px;height:20px">
                                 ...
                                 <li class="list-info-group-item"><span>
                                   <!--  <ion-icon name="chevron-forward-outline"></ion-icon><ion-icon name="earth"></ion-icon> -->
<lord-icon
