         ...
         <div class="container">
          ...
          <img src="/imgs/logo.png" alt="" title="phim hay ">
                  ...
                  <p class=""><a class="logo" href="{{route('homepage')}}" title="phim hay ">
                    <img src="{{asset('uploads/logo/'.$info->logo)}}" style="margin-top: 15px;margin-bottom: -20px;height: 30px;">
                  </a></p>
               </div>
                        ...
                        <style type="text/css">
                           ...
                           <div class="form-group form-timkiem">
                              ...
                              <form class="example" action="{{route('tim-kiem')}}" method="GET" >
                                 <input type="text" name="search" id="timkiem" placeholder="Nhập tên phim.." autocomplete="off">
...
<!-- end đăng nhập -->
               ...
               <div class="collapse navbar-collapse" id="halim">
                  <div class="menu-menu_1-container">
                     <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        <li class="current-menu-item active"><a title="Trang Chủ"  style="color:yellow;" href="{{route('homepage')}}">
      ...
      <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v14.0" nonce="YxFFFDvQ"></script>
