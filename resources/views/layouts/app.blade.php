            ...
            <div class="navbar-header">
              ...
              <h1>
                <a class="navbar-brand" href="{{ url('/') }}"
                  ><span class="fa fa-area-chart"></span> HOME<span
...
<lord-icon
    ...
    style="width:20px;height:20px">
                ...
                <li class="treeview {{($segment=='episode') ? 'active':''}}">
                  <a href="#">
                    <lord-icon
    src="https://cdn.lordicon.com/ydqfeguo.json"
    trigger="loop"
    delay="2000"
    style="width:20px;height:20px">
</lord-icon>
